            ...
            return(
                 <View style={{flex: 1}}>
                    ...
                    >
                        <Header
                            searchBar rounded
                            style={{position: 'absolute', backgroundColor: 'transparent',alignItems:'center', left: 0, top: 0, right:0,zIndex: 100}}
                        >
                            <View
                            ...
                            <View style={{flexDirection:'row', flex: 2}}>
                                <Icon name="ios-camera" style={{color:'white', fontWeight:'bold'}}
                                onPress={()=>{
                                    this.setState({
                                        type: this.state.type ===
                        ...
                        <View
                            style={{flexDirection:'row', justifyContent:'space-between', paddingHorizontal: 10, marginBottom: 15, alignItems:'flex-end'}}
                        >
